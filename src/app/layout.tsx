...
export const metadata: Metadata = {
  title: "Serenity Hotel - Luxury Accommodations & World-Class Amenities",
  description: "Experience luxury hospitality at Serenity Hotel. Book premium rooms, enjoy fine dining, spa services, and exceptional guest service in our award-winning hotel.",
  keywords: "luxury hotel, accommodation, resort, vacation, hospitality, fine dining, spa",
  metadataBase: new URL("https://serenityhotel.com"),
  alternates: {
    canonical: "https://serenityhotel.com"
  },
  openGraph: {
    title: "Serenity Hotel - Your Perfect Getaway Awaits",
    description: "Discover luxury accommodations and world-class amenities at Serenity Hotel.",
    siteName: "Serenity Hotel",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763890399465-9w8c2c7x.jpg",
        alt: "Serenity Hotel Lobby"
      }
    ]
  },
  twitter: {
    ...
    description: "Book your perfect stay at our award-winning hotel with premium rooms and world-class amenities.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763890399465-9w8c2c7x.jpg"]
  },
  robots: {
    index: true,
    follow: true
